...
<head>
    ...
    <style>
        #bg-login {
            background-image: url(https://stmikpesatnabire.ac.id/uploads/1/4/8/2/148223073/edited/whatsapp-image-2023-12-30-at-16-22-18.jpeg);  
...
<body class="text-center" id="bg-login">
    ...
    <main class="form-signin w-100 m-auto">
        <form action="proses.php" method="post">
            ...
            <h1 class="h2 mb-4 fw-normal text-white">Login - SMP Anigou</h1>
            ...
            <button class="w-100 btn btn-lg btn-primary my-3" type="submit" name="login">Login</button>
            <p class="mt-4 mb-2 text-white" id="tagline"><?= $tagline ?></p>
